...
public sealed class DeadTemporaryEliminationPass : IIrOptimizationPass
{
    ...
    public bool Run(IrFunction function)
    {
        ...
        return EliminateDeadTemporaries(function, liveOut);
    }
    ...
    private static bool EliminateDeadTemporaries(IrFunction function, IReadOnlyList<HashSet<string>> liveOut)
    {
        var changed = false;
